...
function AvatarInitials({ name, size }) {
  ...
  const init =
    ((parts[0] ? parts[0][0] : "") + (parts[1] ? parts[1][0] : "")).toUpperCase() || "?";
...
export default function Incidents() {
  ...
  const stats = {
    ...
    breached: INCIDENTS.filter(
      (i) => i.slaBreached && i.status !== "Closed" && i.status !== "Resolved"
    ).length,
  };
          ...
          <div key={label} className="hi5-card" style={{ padding: "16px 18px" }}>
            <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start" }}>
              <div>
                ...
                <div style={{ fontSize: 11, fontWeight: 500, opacity: 0.55, marginTop: 2 }}>
                  {label}
                </div>
              </div>
              <div
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 8, flexWrap: "wrap" }}>
          <div
            style={{
              ...
              alignItems: "center",
              gap: 8,
              background: "rgb(var(--hi5-border)/0.07)",
              ...
              <button
                ...
                style={{
                  ...
                  border:
                    "1px solid " +
                    (statusFilter === f
                      ? "rgb(var(--hi5-accent)/0.35)"
                      : "rgb(var(--hi5-border)/0.15)"),
                  background:
                    statusFilter === f ? "rgb(var(--hi5-accent)/0.12)" : "transparent",
                  color:
                    statusFilter === f ? "rgb(var(--hi5-accent))" : "rgb(var(--hi5-fg))",
                }}
              >
                {f}
              </button>
          ...
          >
            {PRIORITY_FILTERS.map((p) => (
              <option key={p}>{p === "All" ? "All Priorities" : p}</option>
            ))}
          </select>
              ...
              >
                {["csv", "xlsx", "pdf"].map((t) => (
                  <button
                    ...
                    onMouseEnter={(e) => {
                      e.currentTarget.style.background = "rgb(var(--hi5-border)/0.08)";
                    }}
                    onMouseLeave={(e) => {
          ...
          return (
            <div
              ...
              style={{
                ...
                cursor: "pointer",
                boxShadow: isHov
                  ? "0 8px 28px " + stripe.color + "22, 0 2px 8px rgb(0 0 0/0.07)"
                  : undefined,
                ...
                <div style={{ flex: 1, minWidth: 0 }}>
                  ...
                  >
                    ...
                    <SmallBadge
                      cfg={{
                        ...priorityCfg,
                        Icon: inc.priority === "Critical" ? Flame : inc.priority === "High" ? ArrowUp : null,
                      }}
                      label={inc.priority}
                    />
